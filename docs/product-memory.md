...
- Credibility and demand meters sit on the draft rail from the first pick and recompute after every pick. Hover (desktop) or tap (phone) opens a one-line explainer: tree vs hill. Bars grow and numbers count up (Fermi.gg motion). Demand fill is dusty stone, not coral. Election night is paper and ink: cream cards, pale histogram bars, player marked by a quieter card and a heavier bar — no orange or yellow score card. Reduced motion snaps.
