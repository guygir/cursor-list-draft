...
- Credibility and demand meters sit on the draft rail from the first pick and recompute after every pick. Bars grow and numbers count up (Fermi.gg motion, dark studio). Demand fill is punch coral `#ff5e3a`; credibility stays mandate ochre. Reduced motion snaps.
